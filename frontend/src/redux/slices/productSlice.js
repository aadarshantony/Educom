  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchProducts.fulfilled, (s, a) => {
        s.loading = false;
        // Always guarantee an array even if the API returns something unexpected
        s.items = Array.isArray(a.payload?.products) ? a.payload.products : [];
